...
bool tieneAmper(char **vector_cadenas)
{

    bool llego = false;

    if (vector_cadenas[0] != NULL && strchr(vector_cadenas[0], '&') != NULL ||
        vector_cadenas[1] != NULL && strchr(vector_cadenas[1], '&') != NULL ||
        vector_cadenas[2] != NULL && strchr(vector_cadenas[2], '&') != NULL)
    {
